  ...
  return (
    <div className="p-6 max-w-7xl mx-auto relative">
      ...
      <section className="grid md:grid-cols-3 gap-6 mb-10">
        {/* Card Corporativo clickeable sin botón */}
        <div
          onClick={() => navigate('/corporativo')}
          className="bg-blue-50 border border-blue-300 p-4 rounded-xl shadow transition-transform hover:scale-[1.02] cursor-pointer"
        >
          <h3 className="text-lg font-bold text-blue-700 mb-2 flex items-center gap-2">
            <BarChartBig className="text-blue-700" /> Corporativo
          </h3>
          <p className="text-sm text-gray-700">
            Acceso a reportes globales, usuarios y dashboards centralizados.
          </p>
        </div>
            ...
            <p className="text-sm font-semibold mt-2 flex items-center gap-1">
              {n.activo ? (
                ...
                <span className="text-yellow-600 flex items-center gap-1">
                  <Wrench size={16} /> En construcción
                </span>
              )}
            </p>
          </div>
